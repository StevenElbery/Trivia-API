...
#'''
 # @TODO: 
  ...
  def delete_question(question_id):
    try:
      question = Question.query.filter(Question.category == question_id).one_or_none()
  ...
  try:
    ...
    question = Question(question=new_question, new_answer=new_answer, new_category=new_category, new_difficulty=new_difficulty)
    question.insert()
  ...
  def retrieve_quuz_questions(category):
    body = request.get_json()

    new_difficulty = body.get('difficulty', self.difficulty)
    search = body.get('search', None) 
